 ...
 */
final class Version20210319081641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enchere (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, heure VARCHAR(255) NOT NULL, date_vente VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, numero_tel VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal INT NOT NULL, age INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produitcategorie (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produitcategorie_produit (produitcategorie_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_2C7E48B99C501157 (produitcategorie_id), INDEX IDX_2C7E48B9F347EFB (produit_id), PRIMARY KEY(produitcategorie_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produitcategorie_categorie (produitcategorie_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_7704138A9C501157 (produitcategorie_id), INDEX IDX_7704138ABCF5E72D (categorie_id), PRIMARY KEY(produitcategorie_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE produitcategorie_produit ADD CONSTRAINT FK_2C7E48B99C501157 FOREIGN KEY (produitcategorie_id) REFERENCES produitcategorie (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE produitcategorie_produit ADD CONSTRAINT FK_2C7E48B9F347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE produitcategorie_categorie ADD CONSTRAINT FK_7704138A9C501157 FOREIGN KEY (produitcategorie_id) REFERENCES produitcategorie (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE produitcategorie_categorie ADD CONSTRAINT FK_7704138ABCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produitcategorie_categorie DROP FOREIGN KEY FK_7704138ABCF5E72D');
        ...
        $this->addSql('ALTER TABLE produitcategorie_produit DROP FOREIGN KEY FK_2C7E48B9F347EFB');
        $this->addSql('ALTER TABLE produitcategorie_produit DROP FOREIGN KEY FK_2C7E48B99C501157');
        $this->addSql('ALTER TABLE produitcategorie_categorie DROP FOREIGN KEY FK_7704138A9C501157');
        ...
        $this->addSql('DROP TABLE produitcategorie');
        $this->addSql('DROP TABLE produitcategorie_produit');
        $this->addSql('DROP TABLE produitcategorie_categorie');

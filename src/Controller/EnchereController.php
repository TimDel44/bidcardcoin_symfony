...
class EnchereController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/encherelot", name="enchere_lot", methods={"GET"})
     */
    public function lotsEnchere(Enchere $enchere, LotRepository $lotRepository, Lot $lot): Response
    {
        return $this->render('lot/lotEnchere.html.twig', [
            'lot' => $lot,
            'idenchere' => $lotRepository->LotEncheres($enchere),
        ]);
    }
